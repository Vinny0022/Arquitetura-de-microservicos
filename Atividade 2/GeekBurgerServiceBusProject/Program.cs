...
namespace GeekBurgerServiceBusProject
{
    public class Program
    {
        static string QueueConnectionString = @"Endpoint=sb://geekburgervinicius.servicebus.windows.net/;SharedAccessKeyName=ProductPolicy;SharedAccessKey=9EAmBoNiD/TaEdbHKXQFx0FMj8HJ8g1nw/6UhskNO6k=";
        static string QueuePath = "productchanged";
